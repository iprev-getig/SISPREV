...
<div class="ajax-form">
    <div class="acessos index col-md-10 columns content">
        <h3>
        ...
        <table class="table list table-striped table-hover">
            <thead>
                <tr>
                        ...
                        <th><?= $this->Paginator->sort('del') ?></th>
                        <th><?= $this->Paginator->sort('view') ?></th>
                        <th><?= $this->Paginator->sort('tipo_acesso_id') ?></th>
            ...
            <tbody>
                ...
                <tr>
                        ...
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $acesso->id], ['class'=>'btn btn-danger btn-xs ajax-delete', 'escapeTitle' => false]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
