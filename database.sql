...
insert into users (username, email, nome, password, bloqueado) values ('admin', 'suporte.getig@iprev.sc.gov.br', 'Usuário Master', '$2y$10$VoVeEg8L1rLQW5epdaZeZu5WbKhDbo5HnMac1kvxIkZf3EdQaI7GO', false);
